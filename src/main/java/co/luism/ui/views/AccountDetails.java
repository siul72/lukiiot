...
import co.luism.backend.BankAccount;
...
import co.luism.ui.util.BoxShadowBorders;
...
import co.luism.ui.util.css.WhiteSpace;
...
@Route(value = "account-details", layout = MainView.class)
