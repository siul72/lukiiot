...
import co.luism.ui.components.navigation.tab.NaviTab;
...
import co.luism.ui.views.OnDiagLoginView;
...
public class AppBar extends FlexBoxLayout {
	...
	private void initLoginButton() {
		sign_in = UIUtils.createContrastPrimaryButton("Sign In");
		// sign_in.setClassName(CLASS_NAME + "__avatar");
		sign_in.addClickListener(event -> handleClick());
	}

	private void handleClick() {
		Notification.show("Not implemented", 3000, Notification.Position.BOTTOM_END);
		UI.getCurrent().navigate(OnDiagLoginView.NAME.getValue());
	}
